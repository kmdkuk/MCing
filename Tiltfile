...
local_resource(
    'Watch & Compile (mcing controller)', generate() + controller_binary(),
    deps=['internal', 'api', 'pkg', 'cmd/mcing-controller'],
    ignore=['*/*/zz_generated.deepcopy.go']
)
